...
To quantify the contribution of individual components of NUFROST, we performed an ablation study that systematically removed or replaced key elements of the pipeline. The comparison contrasts the full method with reduced configurations that omit robust fitting or weaken the frequency-aware treatment of irregular observations and high-frequency components.
